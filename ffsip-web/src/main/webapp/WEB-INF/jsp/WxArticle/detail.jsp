				...
				<div class="art-section">
					...
					<div class="art-meta-list">
						<p>
							...
							<span class="art-meta link" onclick="location.href = '/ffsip-web/WxArticle/list.do?memberCode=${member.code }'">
								<span>推荐者：</span>${company == '' ? company.name : member.wxNickName}</span>
